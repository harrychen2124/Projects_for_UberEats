...
df = pd.read_excel('Uber_eats台北市_大同中正萬華區_餐廳網址.xlsx')
...
for store in urls:
    ...
    try:         # 👈👀 正常接單的店家，可直接點選到 "詳細資訊"，走try 📌
        ...
        try:
            type = str(dic_info["servesCuisine"])  # 類型
        except:
            type = ""
    ...
    wb.save("Uber_eats台北市_大同中正萬華區_NoRating餐廳資料_2.xlsx")
driver.quit()